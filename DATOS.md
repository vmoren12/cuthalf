...
2. **Al terminar**, el cliente envía el vale y la lista de cortes: por
   cada nivel, la recta del corte **en coordenadas de la figura**, no de
   la pantalla, y el momento en que se hizo.
